// Credits to Corey Hart (corey@codenothing.com)
// He released a json lint package, but it currently doesn't work with react
// So, we took the file we needed and it's here
